<template>
    <button
        ...
        :class="{
            ...
            'st-button--surface': type === StButtonStyle.SURFACE,
            'st-button--outline': type === StButtonStyle.OUTLINE,
            'st-button--ghost': type === StButtonStyle.GHOST,
            'st-button--plain': type === StButtonStyle.PLAIN,
        }"
    >
        <slot />
    </button>
